...
function IssueList({ issues, isLoading, error, setFilter }) {
  if (isLoading) {
        ...
        <div key={issue.id} className="issue-card">
          <div className="issue-header">
            ...
            <div className="issue-meta">
              ...
              {issue.current_status && (
                <span
                  className="issue-status clickable-status"
                  style={{
                    backgroundColor: STATUS_COLORS[issue.current_status],
                    cursor: "pointer",
                  }}
                  onClick={() => setFilter?.(issue.current_status)}
                  title={`Filter by ${STATUS_LABELS[issue.current_status]}`}
                >
          ...
          <div className="issue-footer">
            <div className="issue-submitter">
              Submitted by: {issue.submitted_by_details?.email || "Unknown"}
            </div>
